...
class TripletEvaluatorTensorboard(SentenceEvaluator):
    """
    ...
    def __init__(
        ...
        self.name = name
        self.logs_writer = SummaryWriter(log_dir=tb_logdir, comment=tb_comment)
        ...
        if output_path is not None and self.write_csv:
            ...
            if not os.path.isfile(csv_path):
                with open(csv_path, newline="", mode="w", encoding="utf-8") as f:
                    ...
                    # if steps != -1:
                    #     self.logs_writer.add_scalar('epochs',
                    #                                 epoch,
                    #                                 steps)
                    #
                    #     self.logs_writer.add_scalar('accuracy_manhattan',
                    #                                 accuracy_manhattan,
                    #                                 steps)
                    #
                    #     self.logs_writer.add_scalar('accuracy_cosine',
                    #                                 accuracy_cos,
                    #                                 steps)
                    #
                    #     self.logs_writer.add_scalar('accuracy_euclidean',
                    #                                 accuracy_euclidean,
                    #                                 steps)
                ...
                with open(csv_path, newline="", mode="a", encoding="utf-8") as f:
                    ...
                    #                                 steps)
                    #
                    #     self.logs_writer.add_scalar('Accuracy_metrics/accuracy_manhattan',
                    #                                 accuracy_manhattan,
                    #                                 steps)
                    #
                    #     self.logs_writer.add_scalar('Accuracy_metrics/accuracy_cosine',
                    #                                 accuracy_cos,
                    #                                 steps)
                    #
                    #     self.logs_writer.add_scalar('Accuracy_metrics/accuracy_euclidean',
                    #                                 accuracy_euclidean,
                    #                                 steps)
