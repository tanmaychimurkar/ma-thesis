...
--model_dir=classification-xlm-job-ads-mlm-4650 \
--model_checkpoint=checkpoint-40725 \
--epochs=1 \
--batch_size=16 \
--pretrained_mode=False \
--pretrained_model=bert-base-uncased \
--outdir=mnr-hardneg-classification-on-xlm-finetuned-jobads-checkpoint-4650
