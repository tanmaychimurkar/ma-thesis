...
#SBATCH --job-name="de_xlm-ft-600-hard"
#SBATCH --mem-per-cpu=4096
#SBATCH --tmp=72000
#SBATCH --output="/cluster/scratch/yakram/job_logs/de_xlm-ft-600-hard.out"
#SBATCH --error="/cluster/scratch/yakram/job_logs/de_xlm-ft-600-hard.err"
